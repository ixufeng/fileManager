...
public class FileReader {
	...
	public FileReader(String fileRandomName,HttpServletResponse response){
    ...
    public void readFileByBytes() {
        ...
        File file = new File(fileRandomName);
        InputStream in = null;
    ...
    public  void readFileByChars() {
        ...
        try {
            ...
            int charread = 0;
            reader = new InputStreamReader(new FileInputStream(fileRandomName));
    ...
    public  void readFileByRandomAccess() {
        ...
        try {
            ...
            // 打开一个随机访问文件流，按只读方式
            randomFile = new RandomAccessFile(fileRandomName, "r");
            // 文件长度，字节数
